...
{
	Super::BeginPlay();
	// Keep path following from directly replacing launch velocity when HitReact sets MaxWalkSpeed to zero.
...
{
	UAuraAbilitySystemLibrary::InitializeEnemyDefaultAttributes(this, CharacterClass, Level, AbilitySystemComponent);
}
